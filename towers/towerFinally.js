...
class TowerFinally {
    ...
    static ArrowBow_4(world) {
        ...
        res.imgIndex = 4;
        res.price = 150;
        res.comment = "四级金针菇更换了弓箭子弹，伤害提高了";
        res.audioSrcString = "sound/发射音效/弓箭发射.mp3";
        return res;
    }
    ...
    static Crossbow_1(world) {
        ...
        res.imgIndex = 3;
        res.price = 120;
        res.comment = "视野范围没有金针菇那么大，但是射速更快了";
        res.audioSrcString = "sound/发射音效/弓箭发射.mp3";
        return res;
    }
    ...
    static StoneCannon(world) {
        ...
        b.imgIndex = 7;
        b.price = 100;
        b.comment = "发射真菌蛋子，威力超过金针菇很多很多，但是攻击速度慢了";
    ...
    static StoneCannon_Power_1(world) {
        ...
        b.imgIndex = 9;
        b.price = 120;
        b.comment = "发射大型真菌蛋子，大型石头蛋子打中怪物之后会碎裂成一些有伤害的小真菌蛋子";
        b.audioSrcString = "sound/子弹音效/石头蛋子.mp3";
        return b;
    }
    ...
    static StoneCannon_Power_2(world) {
        ...
        b.imgIndex = 9;
        b.price = 300;
        b.comment = "增加了一点攻击范围，真菌蛋子滑出视野的距离增加了";
        b.audioSrcString = "sound/子弹音效/石头蛋子.mp3";
        return b;
    }
    ...
    static ArmorPiercing_1(world) {
        ...
        b.imgIndex = 28;
        b.price = 220;
        b.comment =  `穿甲杏鲍菇的子弹能够穿过敌人，在穿过敌人的过程中对敌人持续造成伤害，但是子弹半径会变小，直到子弹消失，消失前子弹伤害是不变的`;
